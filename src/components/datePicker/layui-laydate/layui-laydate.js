...
const layDate = function () {
      ...
      link: function (e, a, i) {
        if (n.path) {
          ...
          var s = (i || e).replace(/\.|\//g, ""),
            l = "layuicss-" + s,
            d = 0;
          o.rel = "stylesheet", o.href = '', o.id = l, document.getElementById(l) || r.appendChild(o), "function" == typeof a && ! function c() {
  ...
  C.prototype = [], C.prototype.constructor = C, w.extend = function () {
    ...
    }), e.elemID = "layui-laydate" + t.elem.attr("lay-key"), (t.show || a) && e.render(), a || e.events(), t.value && (t.value.constructor === Date ? e.setValue(e.parse(0, e.systemDate())) : e.setValue(t.value)))
    ...
    function hasFixedParent(el) {
      ...
      while (true) {
        ...
        if (getCssAtrribute(parent, "position") === "fixed") {
          return true;
        }
    ...
    //  获取元素指定css属性
    function getCssAtrribute(el, arr) {
      return getComputedStyle(el)[arr];
    }

    // 进行定位
    let target = e.bindElem || e.config.elem[0]
    t.position = hasFixedParent(target) ? 'fixed' : 'absolute'
    ...
    return "limit" === e ? (c(o), i) : (l = l || r.value, "string" == typeof l && (l = l.replace(/\s+/g, " ").replace(/^\s|\s$/g, "")), i.startState && !i.endState && (delete i.startState, i.endState = !0), "string" == typeof l && l ? i.EXP_IF.test(l) ? r.range ? (l = l.split(" " + r.range + " "), i.startDate = i.startDate || i.systemDate(), i.endDate = i.endDate || i.systemDate(), r.dateTime = w.extend({}, i.startDate), w.each([i.startDate, i.endDate], function (e, t) {
      m(t, l[e], e)
    })) : m(o, l) : (i.hint("日期格式不合法<br>必须遵循下述格式：<br>" + (r.range ? r.format + " " + r.range + " " + r.format : r.format) + "<br>已为你重置"), a = !0) : l && l.constructor === Date ? r.dateTime = i.systemDate(l) : (r.dateTime = i.systemDate(r.showDate), delete i.startState, delete i.endState, delete i.startDate, delete i.endDate, delete i.startTime, delete i.endTime), c(o), a && l && i.setValue(r.range ? i.endDate ? i.parse() : "" : i.parse()), e && e(), i)
    ...
    if (T[0] < 1 && (T[0] = 1), "year" === e) {
      ...
      let datetimetype = a.isHH_mm ? [24, 60] : [24, 60, 60];
      w.each(datetimetype, function (e, t) {
        var a = w.elem("li");
        if (datetimetype.length === 2) {
          a.style = 'width: 50%';
          a.className = 'hhmm'
        }
        var i = ["<p>" + r.time[e] + "</p><ol>"];
    ...
    if (y && h.removeChild(y), h.appendChild(d), "year" === e || "month" === e) w(n.elemMain[t]).addClass("laydate-ym-show"), w(d).find("li").on("click", function () {
      ...
      var S = w.elem("span", {
        ...
        H = w(c[2]).find("." + v);
      k(), S.innerHTML = a.range ? [r.startTime, r.endTime][t] : '选择时间', w(n.elemMain[t]).addClass("laydate-time-show"), H[0] && H.remove(), c[2].appendChild(S), w(d).find("ol").each(function (e) {
        var t = this;
    ...
    if (r = {
      ...
      if (n.range) {
        ...
        w(t.footer).find(g)["removeClass"](s)
      } else "static" === n.position ? (l(!0), t.calendar().done().done(null, "change")) : "date" === n.type ? (l(!0), t.setValue(t.parse()).remove().done()) : "datetime" === n.type && (l(!0), t.calendar().done(null, "change"))
    let timeBtn = document.getElementsByClassName('laydate-btns-time')[0]
    timeBtn && this.tool(timeBtn, 'datetime')
      ...
      o = {
        ...
        confirm: function () {
          if (a.range) {
            ...
            else if (n.startDate && !n.endDate) n.endDate = n.startDate
    ...
    w(e.elem).on("click", function (e) {
      ...
      const type = ['year', 'month'];
      if (type.includes(_this.config.type) && e.target.tagName === 'LI' && !e.target.className.includes('laydate-disabled')) {
        _this.tool(this, 'confirm')
      }
